...
public class Email {
	...
	private final static String myEmailAccount = "1369324562@qq.com";
	private final static String myEmailPassword = "ldmwqdjeiaaafigh";
	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	private final static String myEmailSMTPHost = "smtp.qq.com";
	// 邮件主题
	private final static String mailSubject =  "WeShare校园雨伞共享平台验证码";
	// 收件人邮箱
	private String receiveMailAccount;
	// 邮件内容
	private String mailContent;
    
	public Email(String receiveMailAccount,String mailContent){
	...
	public void Send() throws Exception{
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount); // 创建邮件对象
	...
	public MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception{
		...
		// 2. From: 发件人
		message.setFrom(new InternetAddress(sendMail,"WeShare官方","UTF-8"));
